      ...
      .catch((e) => {
        ...
        if (e.response.status === 400) {
          setValues({
            ...
            snackbarErrorMessage: "Email ya registrado",
          });
        }
      });
  };
    ...
    <div>
      <Container component="main">
        <Typography variant="body2" gutterBottom>
          Es necesario tener una cuenta para poder responder las encuestas. Para
          crear la es necesario que tengas un email @fi.uba.ar
        </Typography>
