...
const AnswerOfQuestionaryView = (props) => {
    ...
    useEffect(() => {
        fetchAnswersOfQuestionaryWithQuestionaryInfo(questionaryHash, setAnswer, setLoading)
    ...
    const createOptions = (options, optionsSelected, canShowResult) => {
        ...
        return options.map((option) => {
            ...
            return <ListItem key={option.id} role={undefined} dense button>
                <ListItemIcon>
                    <>
                        {
                            canShowResult ?
...
function fetchAnswersOfQuestionaryWithQuestionaryInfo(questionaryHash, setAnswer, setLoading) {
    setLoading(true)
